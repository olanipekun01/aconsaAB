...
class Student(models.Model):
    ...
    user = models.OneToOneField(CustomUser, on_delete=models.CASCADE, related_name='stream_b_student', primary_key=True)
...
def create_enrollment_for_student(sender, instance, created, **kwargs):
    if created:
        try:
            ...
            print("No current session found for Stream B.")